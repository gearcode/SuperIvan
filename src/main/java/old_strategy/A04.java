...
public class A04 implements IStrategy {
	...
	public Integer gap = 10;
	
	@Configurable("连续反向平仓次数")
	public int times = 2;
	...
	int long_times = 0, short_times = 0;
